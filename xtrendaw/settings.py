...
# الصوت
# ─────────────────────────────────────────────────────────────
# 🎙️ نبرة المحتوى الديني (تحديث 2026-09-25): «وقار + وضوح مخارج»
#   - السرعة: كانت +8% (مستعجلة) → +4% = إيقاع تدبّر، وكل كلمة تبان.
#   - النبرة: كانت +12Hz (مرتفعة، بتحس إنها بتقرا إعلان) → +4Hz = طبيعية ووقورة.
#   - الصوت: ar-SA-HamedNeural (سعودي فصيح، هادئ) — الأنسب للقرآن والذكر.
VOICE_AR = get("XT_VOICE_AR", "ar-SA-HamedNeural")
VOICE_EN = get("XT_VOICE_EN", "en-US-JennyNeural")
VOICE_RATE = get("XT_VOICE_RATE", "+4%")
VOICE_PITCH = get("XT_VOICE_PITCH", "+4Hz")
# سرعة سرد التفسير/الحديث (أبطأ شويّة من الهوك: مخارج أوضح للكلام الشرعي)
VOICE_RATE_TAFSIR = get("XT_VOICE_RATE_TAFSIR", "+0%")
